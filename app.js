...
const invoiceData = {
  ...
  notificationUrl: "http://localhost:5500/success.html",
...
(function () {
  ...
  var origin =
    "http://chat.btcpayserver.org join us there, and initialize this with your origin url through setApiUrlPrefix";
